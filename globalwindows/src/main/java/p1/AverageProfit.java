...
public class AverageProfit
{
    public static void main(String[] args) throws Exception
    {
        ...
        DataStream<Tuple5<String, String, String, Integer, Integer>> reduced = mapped
                //de aqui salen varios streams con los elementos por grupo
                .keyBy(0)
                //para cada uno se crea una ventana global
                .window(GlobalWindows.create())
                //cuando la cuenta llega a 5 por id hace el reduce ( este proceso es en paralelo)
                .trigger(CountTrigger.of(5))
                .reduce(new Reduce1());
        // June { [Category5,Bat,12,1] Category4,Perfume,10,1}	//rolling reduce
        // reduced = { [Category4,Perfume,22,2] ..... }
        reduced.writeAsText("/home/estevo/tfmflink/globalwindows/www.txt");
        // execute program
