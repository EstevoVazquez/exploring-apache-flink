...
public class SplitDemo
{
    public static void main(String[] args) throws Exception
    {
        ...
        //Compact sintax
         /*SplitStream<Integer> evenOddStream= text.map(t-> Integer.parseInt(t)).split(v->{
            List<String> out = new ArrayList<String>();
            if (v%2 == 0)
                out.add("even");              // label element  --> even 454   odd 565 etc
            else
        ...
        evenData.writeAsText(params.get("output").concat("/even"));
        oddData.writeAsText(params.get("output").concat("/odd"));
