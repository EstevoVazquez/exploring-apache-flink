...
public class JoinExample
{
    public static void main(String[] args) throws Exception
    {
        ...
        joined.writeAsCsv(params.get("output").concat("inner_j_result.txt"), "\n", " ");


        DataSet<Tuple3<Integer, String, String>> ljoined = personSet.leftOuterJoin(locationSet).where(0) .equalTo(0)
                .with(new JoinFunction<Tuple2<Integer, String>, Tuple2<Integer, String>, Tuple3<Integer, String, String>>()
                {
                    public Tuple3<Integer, String, String> join(Tuple2<Integer, String> person,  Tuple2<Integer, String> location)
                    {
         ...
         ljoined.writeAsCsv(params.get("output").concat("left_j_results.txt"), "\n", " ");
        ...
        DataSet<Tuple3<Integer, String, String>> rjoined = personSet.rightOuterJoin(locationSet).where(0) .equalTo(0)
                .with(new JoinFunction<Tuple2<Integer, String>, Tuple2<Integer, String>, Tuple3<Integer, String, String>>(){
          ...
          rjoined.writeAsCsv(params.get("output").concat("right_j_results.txt"), "\n", " ");
